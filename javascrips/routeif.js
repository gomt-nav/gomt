...
document.addEventListener("DOMContentLoaded", function () {
    checkLoginStatus(); // 檢查登入狀態，未登入顯示提示

    function checkLoginStatus() {
        // 假設你將使用者資料存儲在 IndexedDB 中
    ...
    <h1 class="page-title">路線資料</h1>
   <button type="button" class="btn btn-primary w-100" onclick="window.location.href='./login.html'">登入</button>

</div>`;
                } else {
                    // 使用者已登入，繼續正常加載路線資料
                    loadRouteData();  // 載入路線資料的函數
                }
            };
