...
function openDatabase() {
    ...
    request.onupgradeneeded = function(event) {
        ...
        if (!db.objectStoreNames.contains('routeRecords')) {
            let routeRecordsStore = db.createObjectStore('routeRecords', { keyPath: 'recordId' }); // 指定 recordId 為主鍵
            routeRecordsStore.createIndex('routeName', 'routeName', { unique: false }); // 建立索引 routeName
            routeRecordsStore.createIndex('date', 'date', { unique: false }); // 建立索引 date
        }
